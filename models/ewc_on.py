...
def get_parser() -> ArgumentParser:
    ...
    parser.add_argument('--adjust_fisher', action='store_true', default=False,  help='gamma parameter for EWC online')
    return parser
...
class EwcOn(ContinualModel):
    ...
    def end_task(self, dataset):
        ...
        if self.args.adjust_fisher:
            print('Adjusting Fisher')
            self.fish = self.adjust_fisher()
